...
export const Nav = ({ active }) => {
  return (
    ...
    >
      ...
      <button
        className="bg-secondary border p-4 rounded text-base cursor-pointer text-white w-full transition-all flex items-center justify-center gap-4 flex-row-reverse hover:bg-primary"
        title="Adicionar"
      >
